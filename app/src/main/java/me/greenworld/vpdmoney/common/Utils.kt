...
class CustomProgressDialog(context: Context, activity: Activity) {
    ...
    init {
        ...
        setColorFilter(
            ...
            ResourcesCompat.getColor(context.resources, R.color.colorSnackBarSuccess, null)
        )
    ...
    class CustomDialog(private val context: Context) : Dialog(context, R.style.CustomDialogTheme) {
        init {
